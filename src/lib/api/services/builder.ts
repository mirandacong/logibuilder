...
export type BuilderService = EditorService

@injectable()
export class BuilderServiceImpl
    extends EditorServiceImpl implements BuilderService {
...
export class BuilderServiceBuilder extends
    Builder<BuilderService, BuilderServiceImpl> {
    public constructor(obj?: Readonly<BuilderService>) {
        const impl = new BuilderServiceImpl()
        if (obj)
            BuilderServiceBuilder.shallowCopy(impl, obj)
        super(impl)
    }
