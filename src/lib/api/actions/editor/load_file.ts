...
import {getCustomSheetPayloads, getSetModelPayloads, openExcel} from '../lib'
...
class ActionImpl implements Action {
    ...
    public actionType = ActionType.LOAD_FILE
    ...
    public getPayloads(
        ...
        return openExcel(this.excel.buffer).pipe(
            map(wb => {
                const ps = getCustomSheetPayloads(wb, model.book)
                payloads.push(...ps)
                return payloads
            }),
