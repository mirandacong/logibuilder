 ...
 */
export const VERTICALS: readonly (readonly [
    Vertical, GC.Spread.Sheets.VerticalAlign
])[] = [
 ...
 */
export const BORDERS: readonly (readonly [
    LineType, GC.Spread.Sheets.LineStyle
])[] = [
